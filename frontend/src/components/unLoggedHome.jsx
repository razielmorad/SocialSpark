        ...
        <div className="container ">
          <div className="mb-4 bg-secondary rounded-3">
            ...
            <div className="container-fluid py-5">
              ...
              <p className=" fs-6">
                Welcome to our social network, where you can connect with
                friends, share your passions, and explore a wide range of
                interests. Join conversations, discover new opportunities, and
                create meaningful connections along the way.
              </p>
              <Link
                to={"/ulAbout"}
          ...
          <div className="row align-items-md-stretch">
            <div className="col-md-6">
              <div className="h-100 p-5 text-bg-dark rounded-3">
                ...
                <p>
                  Welcome back! Sign in to access your account and dive back
                  into the social network. Stay connected with friends, explore
                  engaging content, and stay up to date with the latest trends
                  and conversations.
                </p>
                <Link
                  to={"/signin"}
