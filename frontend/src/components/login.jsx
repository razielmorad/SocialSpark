      ...
      <div className="container">
        ...
        >
          <img
            ...
            height={"130px"}
          />
          <h1 className="visually-hidden h3 mb-3 fw-normal">Please sign in</h1>
          {error && (
          ...
          <button onClick={() => navigate("/signup")} className="btn btn-lg ">
            <span className="text-light btn btn-outline-secondary">sign up here</span>
          </button>
